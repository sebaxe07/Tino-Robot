...
\chapter{Pre Tino \& goal}
\chapter{SLAM, process and R\&D}
\chapter{General sensor stuff speaker, mic, VR}
\chapter{Legacy to ROS2 migration \& ROS arquitecture}
\chapter{Physical changes}
\chapter{Testing}

\addtocontents{toc}{\vspace{2em}} % Add a gap in the Contents, for aesthetics
\mainmatter % Begin numeric (1,2,3...) page numbering

\input{Chapters/temporalRD}
...
% Commented out since no formal citations are used in the current document
