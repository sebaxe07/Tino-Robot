...
SERIAL_RATE = 0.1  # Intervallo tra i messaggi seriali
TOT_MSG = 2  # Numero di messaggi da inviare
...
def serial_comm(write_queue, read_queue, ser_base, ser_leg):
...
class Controller:
    def loop(self):
        ...
        serial_comm_process = multiprocessing.Process(target=serial_comm, args=(write_queue, read_queue, ser_base, ser_leg))
