    ...
    def process_gamepad_event(self, event):
        ...
        if event.code == 5:  # BF button
            if 120 <= event.value <= 130:
                ...
                # return ( mapRange(event.value, 0, 60, 0, 15) if event.value <= 60 else mapRange(event.value, 60, 120, 15, 20) if 60 < event.value <= 120 else mapRange(event.value, 130, 255, 0, 0))
               
        
        elif event.code == 2:  # BB button
            if 110 <= event.value <= 140:
                return 0
            else:
                return mapRange(event.value, 140, 255, 0, -1.1) if event.value > 140 else mapRange(event.value, 0, 110, 1.1, 0)

        elif (event.code == 0 and event.type == 3):   # HY button
            if 120 <= event.value <= 130:
                return 511
            else:
        ...
        elif event.code == 1:    # HX button
            if 120 <= event.value <= 130:
                return 511
            else:
                return mapRange(event.value,(130 if event.value <120 else (0)),(255 if event.value <120 else (120)),(512 if event.value <120 else (0)),(1024 if event.value <120 else (511)))

        elif event.code ==17:  # HP button
